...
Status: landed on `main`; reverified at `dc4eecfa` on 2026-03-31 with focused route proofs and no remaining product delta in this family
...
- The current `main` head still preserves that contract, and the focused route
  proofs passed again at `dc4eecfa` on 2026-03-31 without additional product
