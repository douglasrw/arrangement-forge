...
Status: landed on `main`; reverified again on 2026-04-02 with the
focused parser, input-surface, generation-block, and type-check proofs passing
against the then-current verified local `main` and `origin/main` head
`fd799d4a`, no remaining
...
- the current proof set still matches the same bounded parser, input-surface,
  and generation-block contract after the 2026-04-02 recheck against the
  current verified `main` and `origin/main` head `fd799d4a`
...
- Verified `main` and `origin/main` head on 2026-04-02: `fd799d4a1c01d02e4ff94d66bc4ae3c21d7a5bac`
